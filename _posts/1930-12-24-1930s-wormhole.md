...
It is because humanity has discovered, developed, deployed, and disseminated useful knowledge that an ever-rising proportion of the world’s population is, at last, escaping the “poor, nasty, brutish and short” lives of our ancestors, pithily described by the philosopher Thomas Hobbes in the 17th century. Nowadays, people are becoming cyborg with a supercomputer in their pocket. With the sheer amount of information available in the world today, we have become overwhelmed. Our mind is in a constant racing state, without structured, meaningful direction.

We need to change it. I believe the future of human thinking is to decentralize our knowledge/intelligence to a more efficient and deep thinking network with AI and iterate it like a Git-based machine. By doing so, we can have the ultimate tool to digest and create knowledge faster, deeper and together. 

That’s why I'm building Wormhole Technologies. 
