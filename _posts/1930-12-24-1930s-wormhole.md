...
With the sheer amount of information available on the internet today, our mind is in a constant racing state. We are becoming cyborg with a supercomputer in our pocket without a structured, meaningful thinking direction.

We need to change it. I believe the future of human thinking is to decentralize our knowledge and intelligence to a more efficient thinking network with AI. Together with AI, we can digest and create knowledge faster, deeper.

This is a future we ought to want. The old monopoly should be gone. 
