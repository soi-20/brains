...
People now are becoming cyborg with a supercomputer in their pocket. With the sheer amount of information available in the world today, our mind is in a constant racing state, without structured, meaningful thinking direction.

We need to change it. I believe the future of human thinking is to decentralize our knowledge/intelligence to a more efficient and deep thinking network with AI and iterate it like a machine. By doing so, we can digest and create knowledge faster, deeper and together. 
