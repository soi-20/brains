...
## Table of Contents ([Essay still in process 30%](https://github.com/functionalflow/brains/blob/master/_pages/functionalflow.md))
...
Again, functional flow is the mind state where you can think almost everything as a function.
